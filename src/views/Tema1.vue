  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .bg_img_01
      .row.justify-content-center.align-items-center
        .col-lg-7
          figure
            img(src="@/assets/curso/tema1/t1_02.svg", alt="alt").img630.m-auto
        .col-lg-5
          figure
            img(src="@/assets/curso/tema1/t1_03.png", alt="alt").img450.m-auto
    ...
    .bg_img_01.mb-5
      .row.justify-content-center.align-items-center
        .col-lg-7.mb-5.mb-lg-0
          figure(data-aos="fade-right")
            img(src="@/assets/curso/tema1/t1_05.svg", alt="alt").img630.m-auto
        .col-lg-5
          figure(data-aos="fade-left")
            img(src="@/assets/curso/tema1/t1_06.svg", alt="alt").img450.m-auto

    p Los equipos dinámicos con movimiento sin traslado, son aquellos que están fijos al piso o techo de la edificación y pueden realizar algún tipo de transporte, como aparece en la siguiente tabla. 
    ...
    figure.mb-5
      img(src="@/assets/curso/tema1/t1_07.png", alt="alt").m-auto

    p.mb-5 Los equipos dinámicos con movimiento y traslado, son aquellos que pueden trasladar mercancías dentro del almacén, y se explican en la siguiente tabla.
    ...
    .row.justify-content-center.mb-5
      .col-lg-10
        .bloque-texto-g.clr--yellow.p-3.p-sm-4.p-md-5
          .bloque-texto-g__img(
            :style="{'background-image': `url(${require('@/assets/curso/tema1/t1_09.png')})`}"
          )
    ...
    .tarjeta.color-primario.p-3.mb-5(data-aos="zoom-in")
      .row.justify-content-around.align-items-center
        .col-3.col-sm-2.col-lg-1
          img(src="@/assets/curso/tema1/t1_17.png")
        .col
          .row.justify-content-between.align-items-center
            .col.mb-3.mb-sm-0              
              p.mb-0 Si es de su interés conocer “seguridad de muelles” se le invita a descargar la Norma Técnica de Prevención 1076_Seguridad en muelles. 
            .col-sm-auto
              a.boton.color-acento-botones.texto-blanco(:href="obtenerLink('/downloads/4_Norma-Tecnica-Prevención-1076_Seguridad-Muelles.pdf')" target="_blank")
                span Descargar
                i.fas.fa-file-download
    ...
    .crd.crd--gradient01.mb-5
      .row.justify-content-center.align-items-center
        .col-auto.mb-5.mb-lg-0
          figure(data-aos="fade-right")
            img(src="@/assets/curso/tema1/t1_18.png", alt="alt").img300.m-auto
        .col-12.col-lg        
          p.mb-0 El espacio físico donde se regula el flujo de entrada y salida de productos, resulta igual de indispensable en la cadena logística. Sin embargo, se debe tener claro desde el diseño y la distribución, cuáles son las zonas del almacén, como se describen a continuación:
      ...
      .col-lg-10
        .crd.crd--slyder.p-5
          SlyderA(tipo="b")
            ...
            .row.justify-content-center.align-items-center
              .col-md-8.mb-4.mb-md-0
                h4.mb-4 Zona de carga y descarga
                p Es el área donde se desarrollan actividades de descarga de los vehículos que traen la mercancía procedente de los proveedores y las devoluciones que realizan los clientes; esta zona cuenta con muelles de carga y descarga.  Aquí se realiza el primer punto de control.      
              .col-md-4
                figure
                  img(src='@/assets/curso/tema1/t1_20.png', alt='').img350.m-auto

            .row.justify-content-center.align-items-center
              .col-md-8.mb-4.mb-md-0
                h4.mb-4 Zona de recepción
                p Entrada de la mercancía, donde se realiza un control cuantitativo (unidades correctas con el registro) y cualitativo de la mercancía (calidad y estado).  Posterior será clasificada y distribuida en la bodega.      
              .col-md-4
                figure
                  img(src='@/assets/curso/tema1/t1_21.png', alt='').img350.m-auto

            .row.justify-content-center.align-items-center
              .col-md-8.mb-4.mb-md-0
                h4.mb-4 Zona de envasado
                p Esta zona se encuentra en aquellas bodegas o almacenes que es necesario volver a envasar o repaletizar (estibar) y conformar nuevas unidades de carga, por razones de almacenamiento, sanidad e higiene.      
              .col-md-4
                figure
                  img(src='@/assets/curso/tema1/t1_22.png', alt='').img350.m-auto

            .row.justify-content-center.align-items-center
              .col-md-8.mb-4.mb-md-0
                h4.mb-4 Zona de cuarentena
                p Estas zonas aplican más para aquellas bodegas que almacenan productos farmacéuticos o agroalimentos, los cuales por normativa exige unos análisis previos al almacenamiento.      
              .col-md-4
                figure
                  img(src='@/assets/curso/tema1/t1_23.png', alt='').img350.m-auto
            ...
            .row.justify-content-center.align-items-center
              .col-md-8.mb-4.mb-md-0
                h4.mb-4 Zona de consolidación
                p La función principal de esta zona es agrupar variedad de productos que correspondan a un mismo pedido, incluso de diferentes proveedores y así realizar un envío de mayor volumen a menor costo.       
              .col-md-4
                figure
                  img(src='@/assets/curso/tema1/t1_25.png', alt='').img350.m-auto

            .row.justify-content-center.align-items-center
              .col-md-8.mb-4.mb-md-0
                h4.mb-4 Zona de embalaje
                p En esta zona se realiza todo el proceso necesario de acondicionamiento de los productos para protegerlos de manera temporal para posterior manipulación y transporte; el embalaje puede ser manual o a través de equipos automatizados.      
              .col-md-4
                figure
                  img(src='@/assets/curso/tema1/t1_26.png', alt='').img350.m-auto

            .row.justify-content-center.align-items-center
              .col-md-8.mb-4.mb-md-0
                h4.mb-4 Zona de control o despacho
                p La función de esta zona es verificar que las mercancías relacionadas en el pedido correspondan con los registros documentales de preparación del pedido o solicitud del cliente.  Por lo regular en esta área se acumulan las mercancías que serán cargadas en los vehículos.   
              .col-md-4
                figure
                  img(src='@/assets/curso/tema1/t1_27.png', alt='').img350.m-auto

            .row.justify-content-center.align-items-center
              .col-md-8.mb-4.mb-md-0
                h4.mb-4 Zona de espera
                p Esta zona es utilizada por lo general para atender los imprevistos que se puedan presentar como: rapidez o lentitud en la preparación de los pedidos y que lleguen a generar adelantos o retrasos al momento de hacer entrega al transportador. 
              .col-md-4
                figure
                  img(src='@/assets/curso/tema1/t1_28.png', alt='').img350.m-auto           

            .row.justify-content-center.align-items-center
              .col-md-8.mb-4.mb-md-0
                h4.mb-4 Zona técnica
              ...
              .col-md-4
                figure
                  img(src='@/assets/curso/tema1/t1_29.png', alt='').img350.m-auto
    ...
    h3.mb-5 Cargue y descargue de mercancías

    .crd.crd--gradient01.mb-5
      .row.justify-content-center.align-items-center
        .col-auto.mb-4.mb-lg-0
          figure(data-aos="fade-right")
            img(src="@/assets/curso/tema1/t1_31.png", alt="alt").img300.m-auto
        .col-12.col-lg        
          p.mb-0 Las operaciones de cargue y descargue de mercancías es una de las labores más importantes de la cadena logística en la que intervienen muchas variables que deben mantenerse bajo estricto control, ya sea para proteger la carga, para llevarla a su destino o para optimizar los costos de almacenamiento y transporte. Su principal objetivo es cargar mercancías adecuadamente, garantizando la calidad y seguridad de los productos.
    ...
    TabsC.color-primario.mb-5
      .py-3.py-md-4(titulo="Rampa hidráulica")
        .row
          .col-md-7.mb-4.mb-md-0
            h4 Rampa hidráulica
            p Se encarga de colocar al mismo nivel el muelle y el vehículo.        
          .col-md-3
            figure
              img(src='@/assets/curso/tema1/t1_32.png').img300.m-auto

      .py-3.py-md-4(titulo="Abrigo retráctil")
        .row
          .col-md-7.mb-4.mb-md-0
            h4 Abrigo retráctil
            p Como su nombre lo indica, su función es proteger la mercancía de impurezas del ambiente, que pueda generar daños.      
          .col-md-3
            figure
              img(src='@/assets/curso/tema1/t1_33.png').img300.m-auto

      .py-3.py-md-4(titulo="Cortinas")
        .row
          .col-md-7.mb-4.mb-md-0
            h4 Cortinas
            p Elemento que evita el ingreso del polvo externo mientras los operarios están descargando o cargando el vehículo.      
          .col-md-4
            figure
              img(src='@/assets/curso/tema1/t1_34.png').img300.m-auto

      .py-3.py-md-4(titulo="Puerta seccional")
        .row
          .col-md-8.mb-4.mb-md-0
            h4 Puerta seccional 
            p Es la puerta de interconexión con el almacén o centro de distribución.      
          .col-md-4
            figure
              img(src='@/assets/curso/tema1/t1_35.png').img300.m-auto

      .py-3.py-md-4(titulo="Pasarela")
        .row
          .col-md-8.mb-4.mb-md-0
            h4 Pasarela 
            p Láminas o pisos falsos que conectan los muelles con los vehículos, para facilitar el flujo de mercancía.   
          .col-md-4
            figure
      ...
      .py-3.py-md-4(titulo="Pasarela")
        .row
          .col-md-8.mb-4.mb-md-0
            h4 Topes
            p Se utilizan para detener el vehículo a distancias específicas. 
          .col-md-4
            figure
              img(src='@/assets/curso/tema1/t1_37.png').img300.m-auto
    ...
    .row.justify-content-center.mb-5
      .col-lg-11
        .bloque-texto-g.clr--pink.p-3.p-sm-4.p-md-5
          .bloque-texto-g__img(
            :style="{'background-image': `url(${require('@/assets/curso/tema1/t1_39.png')})`}"
          )
          .bloque-texto-g__texto.p-5
            p.mb-0 En los últimos tiempos se ha incrementado el comercio electrónico, por tanto, los pedidos a domicilio; lo que significa una reactivación de la economía de manera positiva, mientras para el sector logística podría verlo como una oportunidad para fortalecer y buscar soluciones óptimas para el transporte logístico en los centros de distribución.  El cual debe ser más eficiente; pues de la programación adecuada de las rutas de reparto depende la optimización en los tiempos de entrega, reducción de los costos y satisfacción de los clientes.
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-5.mb-5.mb-lg-0
        figure(data-aos="fade-right")
          img(src="@/assets/curso/tema1/t1_40.png", alt="alt").img500.m-auto
      .col-lg-7
        .sq--pink 
          p La planeación de rutas consiste en definir sobre un plano o un mapa los recorridos que se deben realizar para la distribución, teniendo en cuenta previamente los puntos de entrega, estado y nivel de congestión de las vías, medios de transporte necesarios y disponibles para realizar los recorridos.  En consecuencia, para lograr un eficiente servicio en los tiempos de entrega, aumentar el número de encomiendas y reducir el consumo de combustible, se requiere establecer una planeación de rutas para entrega en el menor tiempo posible y costos razonables.  Así la adecuada planeación de rutas permite realizar actividades adicionales que agreguen valor a la operación; como recogidas extra, entregas adicionales o recibir devoluciones que sumen puntos en la logística inversa, e ir preparando la mercancía para la fase de última milla (entre menos millas se conducen, menos cantidad de vehículos y menor consumo de combustible serán necesarios).

    p Las actividades a desarrollar para una óptima planificación de rutas son:
    ...
    p Los elementos que se necesitan, para lograr una buena planificación y éxito de aquellas compañías que se dedican específicamente al transporte y entrega de mercancías, deben contar con las mejores herramientas de trabajo, con optimizadores de rutas de transporte para medir el desempeño de los empleados en tiempo real. 

    p.mb-5 Una buena planificación de rutas empieza a ser identificada por cada una de las acciones, destinos, rutas y cargas comunes, que nos permita comprender dónde se debe llegar y cuándo crear rutas eficientes. Algunos elementos claves en la planificación y optimización de rutas son:
    ...
    TabsC.color-acento-contenido.mb-5
      .py-3.py-md-4(titulo="Lead time")
        .row
          ...
          .col-md-3
            figure(data-aos="fade-left")
              img(src='@/assets/curso/tema1/t1_42.png').img300.m-auto

      .py-3.py-md-4(titulo="Cadena de valor añadido")
        .row
          .col-md-7.mb-4.mb-md-0
            h4 Cadena de valor añadido
            p El término “cadena de valor añadido” hace referencia a la diferencia entre los beneficios recibidos por el cliente y los costos que ha demandado adquirir el producto; sin embargo, al interior de las organizaciones muchas de ellas logran desarrollar actividades que le agreguen valor al cliente final, las cuales se dividen en dos grandes grupos, así:
        
          .col-md-4
            figure(data-aos="fade-left")
              img(src='@/assets/curso/tema1/t1_43.svg').img450.m-auto

    p.mb-5 Y la diferencia entre cadena logística y cadena de suministro es:

    .titulo-sexto.color-acento-contenido
      h5 Tabla 5.
      span Diferencia entre cadena logística y cadena de suministro

    .row.justify-content-center
      .col-lg-10
        .tabla-a.mb-5
          table.customTable_01
            thead
              tr
            ...
            tbody
              ...
              tr.cell--gray 
                td Aprovisionamiento de productos, transformación y entrega final
                td Flujo de materiales, información y operación en tiempos establecidos
              tr.cell--gray 
                td Desarrollo de producto
                td Tiempo de Gestión en almacenamiento
              tr.cell--gray 
                td Compra de materiales
                td Organización de transporte 
              tr.cell--gray 
                td Abastecimiento
                td Control de inventario
              tr.cell--gray 
                td Producción
    ...
    p.mb-5 Analicemos un ejemplo de aplicación de Sistemas informáticos de gestión de almacén:

    .row.justify-content-center.mb-5
      .col-lg-10
        figure(data-aos="zoom-in")
          img(src="@/assets/curso/tema1/t1_53.png", alt="alt").m-auto
          figcaption.mt-3 Nota. https://elibro-net.bdigital.sena.edu.co/es/ereader/senavirtual/49351
    ...
    h3.mb-5 Integración de las tecnologías
    ...
    .row.justify-content-center.mb-5
      .col-lg-10
        figure(data-aos="zoom-in")
          img(src="@/assets/curso/tema1/t1_56.png", alt="alt").img800.m-auto
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-5.mb-4.mb-lg-0
        figure(data-aos="fade-right")
          img(src="@/assets/curso/tema1/t1_58.png", alt="alt").img450.m-auto
      .col-lg-7
        .crd.crd--gray
          ol.lista-ol--cuadro
            li 
            ...
            li 
              .lista-ol--cuadro__vineta
                span 4
              | Permite hacer cambios y seguimiento durante la cadena de suministro.
            li 
              .lista-ol--cuadro__vineta
                span 5
              | Mayor cantidad de datos almacenados.
    ...
    .row.justify-content-center.mb-5
      .col-lg-11
        .bloque-texto-g.clr--yellow.p-3.p-sm-4.p-md-5
          ...
          .bloque-texto-g__texto.p-5
            p También llamada Cuarta Revolución Industrial, donde el término 4.0 es hablar de innovación, de una nueva forma de hacer logística; donde el uso de herramientas novedosas optimiza el desarrollo de los procesos, cadenas de suministro inteligentes (#[i Big Data o Machine Learning]).

    p.mb-5 En el siguiente recurso podemos conocer en detalle las características de cada una de estas herramientas.

    .row.justify-content-center.mb-5
      .col-lg-10
        .crd.crd--slyder02.p-5
          SlyderA(tipo="b")
            .row.justify-content-center.align-items-center
              .col-md-8.mb-4.mb-md-0
                h4.mb-4 Layout  o diseño áreas de bodega
              ...
              .col-md-4
                figure
                  img(src='@/assets/curso/tema1/t1_61.png', alt='').img350.m-auto
    ...
    h3.mb-5 Fuente de información

    p Debido al volumen de datos que maneja la cadena de suministro es imposible analizar y tomar decisiones con métodos tradicionales, por lo que se requiere organizar las diferentes fuentes para el suministro de información:
        ...
        .crd.crd--gray
          ol.lista-ol--cuadro
            li 
              .lista-ol--cuadro__vineta
                span 1
              | Alertas de desabastecimiento dentro de la distribución.
            li 
              .lista-ol--cuadro__vineta
                span 2
            ...
            li 
              .lista-ol--cuadro__vineta
                span 5
              | Comportamiento de los usuarios, con los registros en sitios web.  Servicio de atención al cliente.
            li 
              .lista-ol--cuadro__vineta
                span 6
              | Reportes del área de transporte: con el apoyo de sensores y tecnologías GPS.  Es posible controlar horarios, recorridos, consumo de combustible, estado del tiempo y de las vías.
            li 
              .lista-ol--cuadro__vineta
                span 7
    ...
    h3 Registros generados en el proceso de preparación de pedidos

    .row.justify-content-center.align-items-center.mb-4
      .col-auto.mb-4.mb-lg-0
        figure(data-aos="fade-right")
          img(src="@/assets/curso/tema1/t1_64.png", alt="alt").img400.m-auto
      .col-12.col-lg
        p Todos los procesos que se desarrollan al interior del almacén deben quedar soportados en los documentos que genera cada una de las tareas; así por ejemplo cuando se realiza una compra virtual debe quedar el registro del pedido de venta y la factura emitida, la cual acompañará la mercancía al momento de llegar al cliente final. 
        p Las empresas operan de forma independiente, sin embargo, existen documentos que son transversales o comunes al interior de su actividad, dentro de los que se encuentran los siguientes:

    ImagenInfografica.color-primario.mb-5(data-aos="zoom-in")
      template(v-slot:imagen)
        figure
          img(src='@/assets/curso/tema1/t1_66.png', alt='')          

      .crd.crd--info(x="10.8%" y="77%" numero="1")
        .h5.mb-2 Orden de trabajo
        p.mb-0 Documento amplio, donde se establece básicamente la actividad que se debe realizar

      .crd.crd--info(x="26.5%" y="54%" numero="2")
        .h5.mb-2 Nota de entrega
        p.mb-0 Documento mercantil que garantiza la entrega o recepción de un producto.

      .crd.crd--info(x="55%" y="20%" numero="3")
        .h5.mb-2 #[i Picking-list]
        p.mb-0 Documento donde están registrados los productos que el operario debe tomar de los estantes para organizar el envío al cliente.

      .crd.crd--info(x="82.8%" y="81%" numero="4")
        .h5.mb-2 #[i Packing-list]
        p.mb-0 Relación de contenidos, documento necesario para la exportación de productos, el cual a va adjunto con la factura comercial.

      .crd.crd--info(x="89%" y="46%" numero="5")
        .h5.mb-2 Hoja de ruta
        p.mb-0 Es la organización de rutas para hacer entrega de los pedidos, donde se relacionan los destinos junto con la orden de entrega. 
    ...
    .titulo-sexto.color-acento-contenido
      h5 Tabla 6.
      span Imprevistos más comunes en la cadena logística 
      ...
      table.customTable_01
        ...
        tbody
          tr.cell--gray 
            ...
            td(rowspan='3')
              | Aunque es dif&iacute;cil prevenir los imprevistos, siempre estar&aacute; presente la posibilidad de ocurrencia; algunas acciones podr&iacute;an ser:
              br
              br
              | - Establecer rutas de reparto habituales y alternativas.
              br
              | - Elaboraci&oacute;n de protocolos de c&oacute;mo actuar en caso de incidentes.
              br
              | - Selecci&oacute;n de proveedores alternativos.
              br
